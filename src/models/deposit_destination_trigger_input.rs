...
pub struct DepositDestinationTriggerInput {
    #[serde(rename = "Type")]
    pub r#type: Type,
    #[serde(rename = "Amount")]
    pub amount: String,
    ...
    pub refund_address: Box<models::DestinationAddress>,
    #[serde(rename = "DepositAddress")]
    pub deposit_address: Box<models::DestinationAddress>,
}

impl DepositDestinationTriggerInput {
    pub fn new(
        r#type: Type,
        amount: String,
        crypto_currency: String,
        refund_address: models::DestinationAddress,
        ...
        DepositDestinationTriggerInput {
            ...
            network: None,
            customer_id: None,
            refund_address: Box::new(refund_address),
...
pub enum Type {
    #[serde(rename = "DepositDestinationTriggerInput")]
    DepositDestinationTriggerInput,
}

impl Default for Type {
    fn default() -> Type {
        Self::DepositDestinationTriggerInput
    }
}
